...
* *SOLID* is a catchy but unfortunate acronym (I think that it evokes images of an impenetrable or unbreakable object). *FLUID* or *ADAPT* would be a more descriptive acronym. 
* In practice, adhering to SOLID is like breaking a cinder block into lego blocks.